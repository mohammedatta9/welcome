...
<hr>
<?php
    $test  = "http://www.google.com/search?hl=en&ie=UTF-8&q=php+development+books&btnG=Google+Search";
    $delims = "?&";
...
<hr/>
<?php 
    echo "<p>Today's date: ".$date_array['mday']."/".$date_array['mon']."/".
        $date_array['year']."</p>";
?>
<hr>
<?php
    //stores the exact timestamp to use in this script
    echo date("d/m/y G:i:s e");
    echo "<br/>";
    echo "Today is ";
...
<hr>
<?php
    // make a timestamp for Feb 28 2006 at 6:48 am
