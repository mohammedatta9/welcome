    ...
    <body>
        ...
        <form action="<?php echo $_SERVER["PHP_SELF"];//الصفحة التي نحن بها ?>" method="POST">
            <p><strong>Type your guess here:</strong>
                <input <?php if($counter>3) echo "disabled" ?> type="text" name="guess" /></p>
            <p><input <?php if($counter>3) echo "disabled" ?> type="submit" value="submit your guess" /></p>
